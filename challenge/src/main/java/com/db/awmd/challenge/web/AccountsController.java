...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferAmount(@RequestBody @Valid Transfer transfer) {
    ...
    try {
      Account transferFrom = this.accountsService.getAccount(transfer.getAccountFrom());
      Account transferTo = this.accountsService.getAccount(transfer.getAccountTo());
      this.accountsService.transferAmount(transferFrom, transferTo,  transfer.getAmount());
